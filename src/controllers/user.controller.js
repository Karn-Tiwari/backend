...
const logOutUser = asyncHandler(async (req, res) => {
  await User.findByIdAndUpdate(
    ...
    {
      $unset: {
        refreshToken: 1, //this removes the field from docuement
      },
    },
    {
      new: true,
...
const refreshAccessToken = asyncHandler(async (req, ref) => {
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  //delete old image after uploading new image
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  //mongoDB me jake dekh bhi sakte hai ki aggregate kya return karta hai aur uske baad usko destructure karke bhi dekh sakte hai
  if (!channel?.length) {
